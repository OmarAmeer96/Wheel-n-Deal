...
class UserChatViewBody extends StatefulWidget {
  const UserChatViewBody({super.key});

  @override
  State<UserChatViewBody> createState() => _UserChatViewBodyState();
}

class _UserChatViewBodyState extends State<UserChatViewBody> {
  @override
