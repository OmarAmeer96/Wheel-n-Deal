...
class CommuterProfileSeenByUserFromTrackingViewBody extends StatefulWidget {
  const CommuterProfileSeenByUserFromTrackingViewBody({super.key});

  @override
  State<CommuterProfileSeenByUserFromTrackingViewBody> createState() =>
      _CommuterProfileSeenByUserFromTrackingViewBodyState();
}

class _CommuterProfileSeenByUserFromTrackingViewBodyState
    extends State<CommuterProfileSeenByUserFromTrackingViewBody> {
