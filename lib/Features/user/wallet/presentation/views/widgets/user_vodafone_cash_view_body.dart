...
class UserVodafoneCashViewBody extends StatefulWidget {
  const UserVodafoneCashViewBody({super.key});

  @override
  State<UserVodafoneCashViewBody> createState() =>
      _UserVodafoneCashViewBodyState();
}

class _UserVodafoneCashViewBodyState extends State<UserVodafoneCashViewBody> {
  String? phoneNumber;
                                ...
                                child: Column(
                                  children: [
                                    ...
                                    CustomMainButton(
                                      ...
                                      onPressed: () {
                                        context
                                            .pushNamed(Routes.kUserWalletView);
                                      },
                                      color: kPrimaryColor,
                                    ),
                                    const SizedBox(
